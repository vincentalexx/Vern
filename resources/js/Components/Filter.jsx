                        ...
                        <li className="block">
                            <div className="flex items-center rounded hover:bg-gray-100">
                                <input
                                    ...
                                    value="automatic"
                                    name="transmission[]"
                                    className="checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded"
                                />
                                <label
                                    htmlFor="automatic"
                    ...
                    <ul className="text-base text-gray-700 flex justify-between">
                        <div className="flex w-[48%] items-center">
                            <input
                                ...
                                htmlFor=""
                                onChange={(e) =>
                                    onPriceStartChange(e.target.value)
                                }
                                type="number"
                                placeholder="Minimum Price"
                                name="min_price"
                                className="checkbox w-full text-sm border-2 pl-8 h-8 rounded"
                            />
                            <label
                                htmlFor="min"
                                className="text-base aspect-square w-7 text-center flex justify-center ml-0.5 items-center absolute rounded-l-sm bg-borderColor font-semibold"
                            >
                                Rp
                            </label>
                        </div>
                        <div className="flex w-[48%] items-center">
                            <input
                                ...
                                htmlFor=""
                                onChange={(e) =>
                                    onPriceEndChange(e.target.value)
                                }
                                type="number"
                        ...
                        <li className="block">
                            <div className="flex items-center rounded hover:bg-gray-100">
                                <input
                                    id="honda"
                                    onChange={(e) =>
                                        onBrandChange("honda", e.target.checked)
                                    }
                                    htmlFor="honda"
                                    type="checkbox"
                                    value="honda"
                        ...
                        <li className="block">
                            <div className="flex items-center rounded hover:bg-gray-100">
                                <input
                                    id="lexus"
                                    onChange={(e) =>
                                        onBrandChange("lexus", e.target.checked)
                                    }
                                    htmlFor="lexus"
                                    type="checkbox"
                                    value="lexus"
                        ...
                        <li className="block">
                            <div className="flex items-center rounded hover:bg-gray-100">
                                <input
                                    id="bmw"
                                    onChange={(e) =>
                                        onBrandChange("bmw", e.target.checked)
                                    }
                                    htmlFor="bmw"
                                    type="checkbox"
                                    value="bmw"
